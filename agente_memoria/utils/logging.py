...
"""Logging utilities for the memory agent."""
...
LOG_DIR = Path(os.getenv("AGENTE_MEMORIA_LOG_DIR", DEFAULT_LOG_DIR))
...
def get_logger(name: str = "agente_memoria", level: int = logging.INFO) -> logging.Logger:
