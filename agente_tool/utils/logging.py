"""Logging utilities for the agente_tool project."""
...
LOG_DIR = Path(os.getenv("AGENTE_TOOL_LOG_DIR", DEFAULT_LOG_DIR))
...
def _configure_file_handler(formatter: logging.Formatter) -> logging.Handler:
    """Create a file handler pointing to the agente_tool log directory."""
...
def get_logger(name: str = "agente_tool", level: int = logging.INFO) -> logging.Logger:
